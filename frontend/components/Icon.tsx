...
type IconName = 'location' | 'printer' | 'star' | 'cube' | 'check' | 'x' | 'upload' | 'arrow-left' | 'business' | 'personal' | 'dashboard' | 'search' | 'lightbulb' | 'user' | 'logout';
...
const ICONS: Record<IconName, JSX.Element> = {
  ...
  business: <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h6M9 11.25h6m-6 4.5h6M3.75 6.75h.75v.75h-.75V6.75zm.75 4.5h-.75v.75h.75v-.75zm-.75 4.5h.75v.75h-.75v-.75zM20.25 6.75h-.75v.75h.75V6.75zm-.75 4.5h.75v.75h-.75v-.75zm.75 4.5h-.75v.75h.75v-.75z" />,
  personal: <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />,
  ...
  lightbulb: <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v2.25m-3.375-3.375a3.375 3.375 0 116.75 0m-6.75 0h6.75M9 12.75a3 3 0 116 0v-3a3 3 0 00-6 0v3z" />,
